...
namespace SLangPlugin
{
    ...
    [ProjectTypeRegistration(SLangPluginPackage.ProjectTypeGuid, "#1", "#2", ProjectExtension, Language, resourcePackageGuid: SLangPluginPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "slangproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "SLangProjectType";

        internal const string Language = "SLang";
