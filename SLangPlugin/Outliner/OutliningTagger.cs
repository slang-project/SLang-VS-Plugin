...
{
    // this is code is based on the Walkthrough: Outlining
    ...
    internal sealed class OutliningTagger : ITagger<IOutliningRegionTag>
    {
        ...
        List<string> startHideList = new List<string>() { "do", "then", "loop"};     //the characters set that start the outlining region
        string endHide = "end";       //the characters that end the outlining region
        ...
        // Step #7: Declare a TagsChanged event handler.
