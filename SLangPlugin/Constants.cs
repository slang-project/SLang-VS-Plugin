...
namespace SLangPlugin
{
    class Constants
    {
        ...
        // should be exclusive:
        public static readonly HashSet<SLang.TokenCode> outlineStartTokenTypes = new HashSet<SLang.TokenCode>() { SLang.TokenCode.Loop, SLang.TokenCode.Then, SLang.TokenCode.Is };
